/** Types aligned with docs/API_CONTRACT.md and docs/DATA_SCHEMA.md */
...
export interface VendorScore {
  ...
  budget_decision: BudgetDecisionCode;
...
export interface RedirectClickRequest {
  vendor_id: string;
  campaign_id: string;
  ip_address: string;
  user_agent: string;
...
export interface RedirectClickResponse {
  received: true;
  click_id: string;
  vendor_id: string;
}
